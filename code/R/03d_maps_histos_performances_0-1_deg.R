...
# p_estreams_tq.evap_estreams: p and evap estreams, t camels

map_width <- fig_width*0.85
map_height <- map_width/0.8 #nice ratio for Europe map

for (v in c("ptq_camels.evap_camels","pt_q_camels.evap_estreams","p_t_estreams_q.evap_estreams",
            "pt_q_camels.evap_camels","p_estreams_tq.evap_estreams")){
...
countries <- countries[-which(countries=="SE")]
...
for (v in c("ptq_camels.evap_camels","pt_q_camels.evap_estreams","p_t_estreams_q.evap_estreams",
  ...
  par(mfrow=c(4,2),mar=c(0.4,0.8,0.5,0.4))
