...
for (v in c("ESTR_min_CAM","P_from_CAM","EVAP_from_CAM","T_from_CAM")){
  ...
  par(mfrow=c(4,2),mar=c(0.4,1.2,0.5,0.4))
...
axis(1,at=c(-1,0,1,3,5),labels=c(-1,0,1,3,5),tck=-0.01,padj=-1,cex.axis=0.8)
axis(2,at=c(-1,0,1,3,5),labels=c(-1,0,1,3,5),tck=-0.01,hadj=0.4,las=2,cex.axis=0.8)
mtext("ΔKGE between scenario II and I",1,cex=0.8,line=1.8)
mtext("ΔKGE between scenario II and III",2,cex=0.8,line=1.8)
legend("topleft",legend=c("CH","CZ","DE","DK","ES","FR","GB","SE"),
       col=c("#472d7b","#3b528b","#2c728e","#21918c","#28ae80","#5ec962","#addc30","#fde725"),ncol=3,pch=20,cex=0.8)
dev.off()
